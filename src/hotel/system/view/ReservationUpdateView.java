 ...
 */
public class ReservationUpdateView extends javax.swing.JFrame {
     ...
     */
    public ReservationUpdateView(ReservationDetailsDto selectedReservationDetailsDto) {
        initComponents();
    ...
    private void initComponents() {
        ...
        comboStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pending", "Confirmed", "Checked-In", "Checked-Out", "Canceled", "Completed", "No-Show", "On-Hold", "Arrived", "In-Progress" }));
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addComponent(txtCheckInTime, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))))
...
//    }
    ...
    private void setReservationDetails(ReservationDetailsDto detailsDto) {
        ...
        if (detailsDto != null) {
            ...
            comboStatus.setSelectedItem(detailsDto.getReserveStatus());
    ...
    private void cancelReservation() {
        ...
        try {
            ...
            Logger.getLogger(ReservationUpdateView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void updateReservation() {
        ...
        dto.setReservationId(txtResId.getText());
        dto.setRoomId(txtRoomID.getText());
        dto.setCustomerId(txtCustomerID.getText());
        dto.setPackageId(txtPackageID.getText());
        dto.setReserveDate(getDate());
        dto.setCheckInDate(dateCheckIn.getDate());
        dto.setCheckInTime(txtCheckInTime.getText());
        dto.setCheckOutDate(dateCheckOut.getDate());
        dto.setCheckOutTime(txtCheckOutTime.getText());
        dto.setReserveStatus(comboStatus.getSelectedItem().toString());
        dto.setAmount(Double.parseDouble(TotalAmountlbl.getText()));
